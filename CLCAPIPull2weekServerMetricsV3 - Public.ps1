...
$APIPass = Read-Host "Please enter your CenturyLink Cloud V1API Password"
...
$highCPUUtil | Select-Object @{Name="Server Name";Expression={$_."Server Name"}}, @{Name="Date & Time";Expression={$_."Date & Time"}}, @{Name="Total CPUs";Expression={$_."CPUAmount"}}, @{Name="CPU Utilization %";Expression={$_."CPUUtil"}}, @{Name="Total Memory in MB";Expression={$_."MemoryMB"}}, @{Name="Memory Utilization %";Expression={$_."MemoryUtil"}}, @{Name="Total Storage in MB";Expression={$_."Storage"}}, @{Name="Total Storage Usage in MB";Expression={$_."StorageUsage"}}, @{Name="Storage Utilization %";Expression={$_."StorageUtil"}} | export-csv "$dir\$AccountAlias-HighCPU-$gendate.csv" -NoTypeInformation

Write-Verbose "Exporting High RAM Utilization data for $AccountAlias." -Verbose

$highRAMUtil | Select-Object @{Name="Server Name";Expression={$_."Server Name"}}, @{Name="Date & Time";Expression={$_."Date & Time"}}, @{Name="Total CPUs";Expression={$_."CPUAmount"}}, @{Name="CPU Utilization %";Expression={$_."CPUUtil"}}, @{Name="Total Memory in MB";Expression={$_."MemoryMB"}}, @{Name="Memory Utilization %";Expression={$_."MemoryUtil"}}, @{Name="Total Storage in MB";Expression={$_."Storage"}}, @{Name="Total Storage Usage in MB";Expression={$_."StorageUsage"}}, @{Name="Storage Utilization %";Expression={$_."StorageUtil"}} | export-csv "$dir\$AccountAlias-HighRAM-$gendate.csv" -NoTypeInformation

Write-Verbose "Exporting High HD Utilization data for $AccountAlias." -Verbose

$highHDUtil | Select-Object @{Name="Server Name";Expression={$_."Server Name"}}, @{Name="Date & Time";Expression={$_."Date & Time"}}, @{Name="Total CPUs";Expression={$_."CPUAmount"}}, @{Name="CPU Utilization %";Expression={$_."CPUUtil"}}, @{Name="Total Memory in MB";Expression={$_."MemoryMB"}}, @{Name="Memory Utilization %";Expression={$_."MemoryUtil"}}, @{Name="Total Storage in MB";Expression={$_."Storage"}}, @{Name="Total Storage Usage in MB";Expression={$_."StorageUsage"}}, @{Name="Storage Utilization %";Expression={$_."StorageUtil"}} | export-csv "$dir\$AccountAlias-HighHD-$gendate.csv" -NoTypeInformation

Write-Verbose "Exporting low CPU Utilization data for $AccountAlias." -Verbose

$lowCPUUtil | Select-Object @{Name="Server Name";Expression={$_."Server Name"}}, @{Name="Date & Time";Expression={$_."Date & Time"}}, @{Name="Total CPUs";Expression={$_."CPUAmount"}}, @{Name="CPU Utilization %";Expression={$_."CPUUtil"}}, @{Name="Total Memory in MB";Expression={$_."MemoryMB"}}, @{Name="Memory Utilization %";Expression={$_."MemoryUtil"}}, @{Name="Total Storage in MB";Expression={$_."Storage"}}, @{Name="Total Storage Usage in MB";Expression={$_."StorageUsage"}}, @{Name="Storage Utilization %";Expression={$_."StorageUtil"}} | export-csv "$dir\$AccountAlias-LowCPU-$gendate.csv" -NoTypeInformation

Write-Verbose "Exporting low RAM Utilization data for $AccountAlias." -Verbose

$lowRAMUtil | Select-Object @{Name="Server Name";Expression={$_."Server Name"}}, @{Name="Date & Time";Expression={$_."Date & Time"}}, @{Name="Total CPUs";Expression={$_."CPUAmount"}}, @{Name="CPU Utilization %";Expression={$_."CPUUtil"}}, @{Name="Total Memory in MB";Expression={$_."MemoryMB"}}, @{Name="Memory Utilization %";Expression={$_."MemoryUtil"}}, @{Name="Total Storage in MB";Expression={$_."Storage"}}, @{Name="Total Storage Usage in MB";Expression={$_."StorageUsage"}}, @{Name="Storage Utilization %";Expression={$_."StorageUtil"}} | export-csv "$dir\$AccountAlias-LowRAM-$gendate.csv" -NoTypeInformation

Write-Verbose "Exporting low HD Utilization data for $AccountAlias." -Verbose

$lowHDUtil | Select-Object @{Name="Server Name";Expression={$_."Server Name"}}, @{Name="Date & Time";Expression={$_."Date & Time"}}, @{Name="Total CPUs";Expression={$_."CPUAmount"}}, @{Name="CPU Utilization %";Expression={$_."CPUUtil"}}, @{Name="Total Memory in MB";Expression={$_."MemoryMB"}}, @{Name="Memory Utilization %";Expression={$_."MemoryUtil"}}, @{Name="Total Storage in MB";Expression={$_."Storage"}}, @{Name="Total Storage Usage in MB";Expression={$_."StorageUsage"}}, @{Name="Storage Utilization %";Expression={$_."StorageUtil"}} | export-csv "$dir\$AccountAlias-LowHD-$gendate.csv" -NoTypeInformation
